...
export default function SocialChip({ label, href, Icon }: SocialChipProps) {
	return (
		<a
			href={href}
			className="group inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/4 px-4 py-2 text-sm text-white/72 transition duration-300 hover:border-[#ff78e9]/35 hover:bg-[#ff78e9]/10 hover:text-[#ffb7f3]"
		>
